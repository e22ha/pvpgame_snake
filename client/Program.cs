...
class Program
{
    ...
    static string TitleWin = "Snake_game";
    ...
    static int Main(string[] args)
    {
        ...
        client.IamWin += Client_IamWin;
        client.IamLose += Client_IamLose;
    ...
    private static void Client_IamLose(object sender, EventArgs e)
    {
        Console.Clear();
    ...
    private static void Client_IamWin(object sender, EventArgs e)
    {
        Console.Clear();
        string[] data = sender.ToString().Split(',');
        Console.WriteLine(data[1]);
        ...
        client.send_msg("/toleaderboard" + name + "," + data[0]);
    }
    ...
    static int RunField(string[] args)
    {
        try
        {
            ...
            TitleWin = "Snake_game " + guid.Substring(0, 4);
            Console.Title = TitleWin;
            string ch = "#";
            string slash = "/";
