    ...
    internal class Client
    {
        ...
        private void show_ping_pong()
        {
            for (int i = 0; i < 3; i++)
            {
                if (i == 0)
                {
                    main.Title = "GAME " + guid.Substring(0, 4) + " SCORE: " + score + " s|1..|c";
                }
                else if (i == 1)
                {
                    main.Title = "GAME " + guid.Substring(0, 4) + " SCORE: " + score + " s|.2.|c";
                }
                else if (i == 2)
                {
                    main.Title = "GAME " + guid.Substring(0, 4) + " SCORE: " + score + " s|..3|c";
                }
